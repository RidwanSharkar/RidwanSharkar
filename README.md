...
.btn-portfolio {
  ...
  box-shadow: 0 0 20px rgba(138,43,226,0.3), 0 0 40px rgba(30,144,255,0.2), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.2);
  color: #ffffff;
  font-weight: 700;
  font-size: 16px;
  letter-spacing: 1px;
...
.btn-portfolio:hover {
  ...
  box-shadow: 0 0 30px rgba(138,43,226,0.6), 0 0 60px rgba(30,144,255,0.4), 0 0 90px rgba(255,20,147,0.3), inset 0 1px 0 rgba(255,255,255,0.2);
...
.btn-avernus {
  ...
  box-shadow: 0 0 20px rgba(0,255,255,0.3), 0 0 40px rgba(0,191,255,0.2), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.2);
  color: #ffffff;
  font-weight: 700;
  font-size: 16px;
  letter-spacing: 1px;
...
.btn-avernus:hover {
  transform: translate(-50%, -50%) scale(1.1);
  box-shadow: 0 0 30px rgba(0,255,255,0.6), 0 0 60px rgba(0,191,255,0.4), 0 0 90px rgba(30,144,255,0.3), inset 0 1px 0 rgba(255,255,255,0.2);
...
.btn-eidolon {
  ...
  box-shadow: 0 0 20px rgba(255,69,0,0.3), 0 0 40px rgba(255,140,0,0.2), inset 0 1px 0 rgba(255,255,255,0.1), inset 0 -1px 0 rgba(0,0,0,0.2);
  color: #ffffff;
  font-weight: 700;
  font-size: 15px;
  letter-spacing: 1px;
...
.btn-eidolon:hover {
  transform: scale(1.1);
  box-shadow: 0 0 30px rgba(255,69,0,0.6), 0 0 60px rgba(255,140,0,0.4), 0 0 90px rgba(255,20,147,0.3), inset 0 1px 0 rgba(255,255,255,0.2);
...
.btn-portfolio:hover .shine,
.btn-avernus:hover .shine,
.btn-eidolon:hover .shine {
  left: 100%;
}
.border-glow {
  position: absolute;
...
.btn-portfolio .border-glow {
  background: linear-gradient(45deg, #8a2be2, #1e90ff, #ff1493, #8a2be2);
}
.btn-avernus .border-glow {
  background: linear-gradient(45deg, #00ffff, #00bfff, #1e90ff, #00ffff);
}
.btn-eidolon .border-glow {
  background: linear-gradient(45deg, #ff4500, #ff8c00, #ff1493, #ff4500);
}
.btn-portfolio:hover .border-glow,
.btn-avernus:hover .border-glow,
.btn-eidolon:hover .border-glow {
  opacity: 1;
}
.btn-portfolio:hover span:first-of-type,
.btn-avernus:hover span:first-of-type,
.btn-eidolon:hover span:first-of-type {
  transform: rotate(360deg) scale(1.2);
  filter: drop-shadow(0 0 15px rgba(138,43,226,1)) brightness(1.5);
}
.btn-avernus:hover span:first-of-type {
  filter: drop-shadow(0 0 15px rgba(0,255,255,1)) brightness(1.5);
}
.btn-eidolon:hover span:first-of-type {
  filter: drop-shadow(0 0 15px rgba(255,69,0,1)) brightness(1.5);
}
.btn-portfolio:hover span:last-of-type {
  color: #e0e0ff;
  text-shadow: 0 0 20px rgba(138,43,226,0.8), 0 0 30px rgba(30,144,255,0.6);
}
.btn-avernus:hover span:last-of-type {
  color: #e0ffff;
  text-shadow: 0 0 20px rgba(0,255,255,0.8), 0 0 30px rgba(0,191,255,0.6);
}
.btn-eidolon:hover span:last-of-type {
  color: #ffe0e0;
